...
const SocialProof = () => {
  ...
  useEffect(() => {
    ...
    const actions = [
      ...
      'طلب استشارة لحل خلاف', 'استفسر عن الأحجار الطبيعية', 'بدأ جلسة توجيه',
      'تخلص من الطاقة السلبية', 'طلب رقية شرعية', 'سأل عن التوافق الأسري',
      'طلب تحصين للمنزل بالذكر', 'تم لم شمل عائلته', 'حصل على القبول والألفة',
      'تيسرت أمور عمله وتجارته', 'تخلص من الأرق والتوتر', 'نجح في إعادة الوفاق',
      'طلب تحصين روحاني شرعي', 'استفسر عن تعزيز المودة والألفة', 'طلب برنامج أذكار للتحصين',
      'استشار في خلافات زوجية متعسرة', 'طلب التخلص من المعوقات النفسية', 'سأل عن الفوائد الطبيعية للقلائد'
    ];
...
function App() {
  ...
  const defaultTexts = useMemo(() => [
    ...
    { id: 'dt11', title: 'التحصين الروحاني اليومي', content: 'الوقاية خير من العلاج. تحصن بأذكار الصباح والمساء واجعل ذكر الله حصناً لبيتك وعائلتك من كل سوء.', order: 110 },
    { id: 'dt12', title: 'تيسير الارتباط والوفاق', content: 'استشارات متخصصة لتذليل العقبات الاجتماعية والنفسية وبناء الثقة لتيسير الارتباط والوفاق واليقين بالفرج.', order: 111 },
    ...
    { id: 'dt15', title: 'إصلاح العلاقات وجمع الشمل', content: 'نسعى دائماً لإصلاح ذات البين وإعادة الاستقرار والمودة بين الأزواج بالوسائل التربوية والشرعية والمودة والإحسان.', order: 114 },
    ...
    { id: 'dt21', title: 'مستشار روحاني وأسري ذو خبرة', content: 'الخبرة والمصداقية هما ما يميزنا. نحن هنا لخدمتكم وإرشادكم للطريق الصحيح بكل أمانة وإخلاص.', order: 120 },
  ], []);
